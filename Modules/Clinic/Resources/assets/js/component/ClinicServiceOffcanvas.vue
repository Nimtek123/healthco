...
import { EDIT_URL, STORE_URL, UPDATE_URL, CATEGORY_LIST, CLINIC_CENTER_LIST, VENDOR_LIST,SUB_CATEGORY_LIST,SYSTEM_SERVICE_LIST, SETTING_DATA,TAX_LIST } from '../constant/clinic-service'
...
//     .min(1, 'Advance payment must be greater than or equal to 1')
