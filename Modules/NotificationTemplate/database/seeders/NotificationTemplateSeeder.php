...
class NotificationTemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $template = NotificationTemplate::create([
            ...
            'status' => 1,
            'to' => '["user","admin", "vendor","receptionist", "doctor"]',
...
<p>Best regards,<br>[[ company_name ]]<br>[[ company_contact_info ]]</p>',
        ...
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            'notification_message' => 'Thank you for booking your appointment! Your appointment has been successfully confirmed. We look forward to seeing you.',
            'status' => 1,
            'subject' => 'Appointment Confirmed!',
            'user_type' => 'user',  // This is the user type you want to add
            'template_detail' => '<p>Your appointment is confirmed! Appointment ID: [[ id ]]. Please check your details in your account.</p>',
        ...
        <p>Best regards,<br>[[ company_name ]]<br>[[ company_contact_info ]]</p>',
            ...
            'sms_template_detail' => '<p>Your appointment is confirmed! Appointment ID: [[ id ]].</p>',
            'sms_subject' => 'Appointment Confirmed!',
            'whatsapp_template_detail' => '<p>Your appointment is confirmed! Appointment ID: [[ id ]].</p>',
...
<p>&nbsp;</p>',
        ...
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            'notification_message' => 'Your password was changed successfully. Secure your account if you did not authorize this.',
            'status' => 1,
...
<p>[[ logged_in_user_fullname ]]<br>[[ logged_in_user_role ]]<br>[[ company_name ]]<br>[[ company_contact_info ]]</p>',
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'sms_template_detail' => '<p>Welcome to KiviCare ,</p>\r\n    <p>New incidence report created.</p>\r\n    <p>Title:  [[ title ]]  ,  Description: [[ description ]] , Phone: [[ phone ]] , Email: [[ email ]]  Created By: [[ user_name ]] </p>',
            'whatsapp_template_detail' => '<p>Welcome to KiviCare ,</p>\r\n    <p>New incidence report created.</p>\r\n    <p>Title:  [[ title ]]  ,  Description: [[ description ]] , Phone: [[ phone ]] , Email: [[ email ]]  Created By: [[ user_name ]] </p>',
        ]);
