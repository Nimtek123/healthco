                ...
                <div class="col-lg-9 mt-lg-0 mt-5">
                    ...
                    <div class="tab-content mt-3">
                        ...
                        <div class="tab-pane p-0" id="service-doctor">
                            @php
                                $availableServices = $doctor->doctorService->filter(function($service) {
                                    return $service->clinicservice !== null;
                                });
                            @endphp
                            
                            @if($availableServices->count() > 0)
                                <ul class="list-inline m-0">
                                    @foreach ($availableServices->take(5) as $doctor_service)
                            ...
                            @else
                                <div class="text-center p-5 section-bg rounded">
                                    <div class="mb-3">
                                        <i class="ph ph-hand-heart" style="font-size: 3rem; color: #ccc;"></i>
                                    </div>
                                    <h5 class="text-muted mb-2">{{ __('frontend.no_services_available') ?? 'No Services Available' }}</h5>
                                    <p class="text-muted mb-0">{{ __('frontend.no_services_message') ?? 'This doctor currently has no services available for booking.' }}</p>
                                </div>
                            @endif
                        </div>
